...
import { AirportDeleteDialog } from './airport-delete-dialog';

describe('Airport Management Delete Component', () => {
  let comp: AirportDeleteDialog;
  let fixture: ComponentFixture<AirportDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AirportDeleteDialog);
