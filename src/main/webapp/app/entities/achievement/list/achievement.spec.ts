...
describe('Achievement Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: 17559 }], { headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' } });
  ...
  describe('trackId', () => {
    it('should forward to achievementService', () => {
      ...
      vitest.spyOn(service, 'getAchievementIdentifier');
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.achievementsParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });
