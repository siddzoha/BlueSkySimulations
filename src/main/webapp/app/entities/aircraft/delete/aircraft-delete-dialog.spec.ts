...
import { AircraftDeleteDialog } from './aircraft-delete-dialog';

describe('Aircraft Management Delete Component', () => {
  let comp: AircraftDeleteDialog;
  let fixture: ComponentFixture<AircraftDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AircraftDeleteDialog);
