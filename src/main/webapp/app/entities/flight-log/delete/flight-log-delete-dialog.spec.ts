...
import { FlightLogDeleteDialog } from './flight-log-delete-dialog';

describe('FlightLog Management Delete Component', () => {
  let comp: FlightLogDeleteDialog;
  let fixture: ComponentFixture<FlightLogDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(FlightLogDeleteDialog);
