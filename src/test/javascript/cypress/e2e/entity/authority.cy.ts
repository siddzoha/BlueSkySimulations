...
describe('Authority e2e test', () => {
  ...
  let username: string;
  let password: string;
  const authoritySample = { name: '7301601d-d71b-4938-8b7e-214700327a16' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('ed976901-70d5-4d52-ac43-092fd3a7059c');
      cy.get(`[data-cy="name"]`).should('have.value', 'ed976901-70d5-4d52-ac43-092fd3a7059c');
